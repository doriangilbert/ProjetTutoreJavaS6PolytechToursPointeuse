...
public class CentralApplicationController
{
	...
	protected void handleButtonCheckInOutHistoryAction(ActionEvent event)
	{
		try
		{
			...
			CentralApplication.root = FXMLLoader.load(getClass().getResource("/fr/univtours/polytech/ptjavapointeuse/centralapp/view/ACCheckInOutHistoryView.fxml"));
	...
	protected void handleButtonParametersAction(ActionEvent event)
	{
		try
		{
			...
			CentralApplication.root = FXMLLoader.load(getClass().getResource("/fr/univtours/polytech/ptjavapointeuse/centralapp/view/ACParametersView.fxml"));
