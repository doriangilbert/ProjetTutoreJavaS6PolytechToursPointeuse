...
import fr.univtours.polytech.ptjavapointeuse.centralapp.model.EmployeeDept;
...
public class ACStaffManagementController
{
	...
	protected void handleButtonCreateEmployee(ActionEvent event)
	{
		try
		{
			...
			CentralApplication.root = FXMLLoader.load(getClass().getResource("/fr/univtours/polytech/ptjavapointeuse/centralapp/view/ACCreateEmployeeView.fxml"));
	...
	protected void handleButtonManageEmployee(ActionEvent event)
	{
		try
		{
			...
			CentralApplication.root = FXMLLoader.load(getClass().getResource("/fr/univtours/polytech/ptjavapointeuse/centralapp/view/ACManageEmployeeView.fxml"));
	...
	protected void handleButtonBackToHome(ActionEvent event)
	{
		try
		{
			...
			// page **//
			CentralApplication.root = FXMLLoader.load(getClass().getResource("/fr/univtours/polytech/ptjavapointeuse/centralapp/view/CentralApplicationView.fxml"));
