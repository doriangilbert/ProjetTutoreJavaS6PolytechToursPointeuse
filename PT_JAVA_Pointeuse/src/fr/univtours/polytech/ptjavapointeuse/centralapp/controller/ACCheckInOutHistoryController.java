...
import fr.univtours.polytech.ptjavapointeuse.centralapp.model.EmployeeCheck;
...
public class ACCheckInOutHistoryController
{
	...
	protected void handleButtonTodayChecks(ActionEvent event)
	{
		try
		{
			...
			CentralApplication.root = FXMLLoader.load(getClass().getResource("/fr/univtours/polytech/ptjavapointeuse/centralapp/view/ACTodayCheckInOutHistoryView.fxml"));
